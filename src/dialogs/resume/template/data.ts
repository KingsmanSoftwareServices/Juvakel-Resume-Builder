...
export const templates = {
	azurill: {
		...
		imageUrl: withBasePath("/templates/jpg/azurill.jpg"),
	...
	bronzor: {
		...
		imageUrl: withBasePath("/templates/jpg/bronzor.jpg"),
	...
	chikorita: {
		...
		imageUrl: withBasePath("/templates/jpg/chikorita.jpg"),
	...
	ditto: {
		...
		imageUrl: withBasePath("/templates/jpg/ditto.jpg"),
	...
	ditgar: {
		...
		imageUrl: withBasePath("/templates/jpg/ditgar.jpg"),
	...
	gengar: {
		...
		imageUrl: withBasePath("/templates/jpg/gengar.jpg"),
	...
	glalie: {
		...
		imageUrl: withBasePath("/templates/jpg/glalie.jpg"),
	...
	kakuna: {
		...
		imageUrl: withBasePath("/templates/jpg/kakuna.jpg"),
	...
	lapras: {
		...
		imageUrl: withBasePath("/templates/jpg/lapras.jpg"),
	...
	leafish: {
		...
		imageUrl: withBasePath("/templates/jpg/leafish.jpg"),
	...
	onyx: {
		...
		imageUrl: withBasePath("/templates/jpg/onyx.jpg"),
	...
	pikachu: {
		...
		imageUrl: withBasePath("/templates/jpg/pikachu.jpg"),
	...
	rhyhorn: {
		...
		imageUrl: withBasePath("/templates/jpg/rhyhorn.jpg"),
